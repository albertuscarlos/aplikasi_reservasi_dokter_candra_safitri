...
class _LoginPageState extends State<LoginPage> {
                   ...
                   if(formKey.currentState!.validate()) {
                     ...
                     pasien.postLogin(
                         ...
                         if(value != null) {
                           ...
                           pageRoute(value[0]['id_pasien'], value[0]['nama_lengkap'], value[0]['jenis_kelamin'], value[0]['tanggal_lahir'], value[0]['no_telepon'], value[0]['foto_pasien'],value[0]['username'], value[0]['password'])
                          }
                         else if (value == null){
                           ScaffoldMessenger.of(context).showSnackBar(SnackBar(
  ...
  void pageRoute(String idPasien, String namaPasien, String jenisKelamin, String tanggalLahir, String noTelepon, String fotoPasien, String username, String password) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
