...
class Reservasi {
  ...
  final _newUrl = 'https://reservasi.klinikdrcandrasafitri.com/api/reservasi/';
  ...
  Future postData(
    ...
    try {
      final response =
          await http.post(Uri.parse(_baseUrl + '/reservasi'), body: {
  ...
  Future deleteReservasi(String id_reservasi) async {
    final response =
        await http.delete(Uri.parse(_newUrl + 'delete/' + id_reservasi));
  ...
  Future ubahData(
    ...
    try {
      final response =
          await http.put(Uri.parse(_newUrl + 'update/' + id_reservasi), body: {
        "nama_pasien": nama_pasien,
        "umur_pasien": umur_pasien,
        "tanggal_reservasi": tanggal_reservasi,
        "alamat": alamat,
